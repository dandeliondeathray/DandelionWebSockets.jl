...
Feature: Section 4.1: Establishing a connection
  ...
  @4_1_EstablishConnection_2-2 @must
  ...
  @4_1_EstablishConnection_2-3 @should @wontimplement
  ...
  @4_1_EstablishConnection_3-2 @should
